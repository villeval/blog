...
PS. If you're more interested in my setup, you can found it from [here](https://vvaltonen/post/gear)). I've also scripted the setup process for my OS and stored my dotfiles in [Github](https://github.com/villeval/dotfiles), so anytime I have to install OS again, I can easily set up the OS for myself just by running the script.