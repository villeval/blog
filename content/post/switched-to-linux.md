...
PS. If you're more interested in my setup, you can found it from [here](https://vvaltonen.com/post/gear). My dotfiles and setup scripts are also available at [Github](https://github.com/villeval/dotfiles).